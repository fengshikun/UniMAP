...
class BertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        use_cache=True,
        pos_lambda1=1.0,
        strucpos_lambda2=1.0,
        strucpos_func='linear',
        num_labels_for_fg=0,
        num_labels_for_formula=0,
        problem_type_for_formula='regression',
        formula_lambda=0.1,
        **kwargs
    ):
        ...
        self.pos_lambda1 = pos_lambda1
        self.strucpos_lambda2 = strucpos_lambda2
        self.strucpos_func = strucpos_func
        self.num_labels_for_fg = num_labels_for_fg
        self.num_labels_for_formula = num_labels_for_formula
        self.problem_type_for_formula = problem_type_for_formula
        self.formula_lambda = formula_lambda
